...
$destinatario='AL SR. JEFE '.$comisaria.'.';

$pdf->writeHTML( utf8_encode($destinatario), true, false, true, false);

$pdf->writeHTML( '<span></span>', true, false, true, false);

$nota='                                        Me dirijo a Ud., a fin de remitir listado de las personas que están declaradas como rebeldes y a las cuales debe traer para hacer comparecer  por ante este Juzgado de Faltas de Tercera Nominación.-';
