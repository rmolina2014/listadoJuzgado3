          ...
          <div class="card-header">
            <h3 class="card-title">
              <font style="vertical-align: inherit;">
                <font style="vertical-align: inherit;">Personas</font>
              </font>
            </h3>
    ...
    <script type="text/javascript">
      ...
      */
      function getIngreso(param) {
        ...
        if (parseInt(valor) && (valor.length == 13)) {
          /* Ingreso por lector de barras */
          Juzgado = valor.substring(0, 1);
          if (Juzgado != "3") {
            alert("El código pertenece a otro juzgado!");
            return 0;
          } /* Control del juzgado propietario del expediente */
          Version = valor.substring(1, 3);
          switch (Version) {
            /* Control de versión de código de barras */
            case "00": {
              ...
              switch (Operacion) {
                case "00":
                  result = {
                    tipo: "0",
                    valor: parseInt(valor.substring(5, 12))
                  };
                  return result; /* Número de expediente */
                case "01":
                  result = {
                    tipo: "1",
                    valor: parseInt(valor.substring(5, 12))
                  };
                  return result; /* Identificador de cédula */
                default:
                  alert("Operacion no soportada! Codigo=" + Operacion);
                  return 0;
              }
            }
            break;
            case "01": {
              ...
              switch (Operacion) {
                ...
                case "01":
                  ...
                  return result; /* Identificador de escrito */
                default:
                  alert("Operacion no soportada! Codigo=" + Operacion);
                  return 0;
              }
            ...
            break;
            default:
              alert("Versión de código no soportada!");
              return 0;
              break;
          }
        } else {
